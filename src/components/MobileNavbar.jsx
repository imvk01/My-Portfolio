  ...
  return (
    ...
    >
      <div
        ...
        bg-white shadow-2xl rounded-r-3xl
        transform transition-transform duration-300 ease-in-out
        ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {/* Gradient Header */}
        <div className="flex justify-between items-center p-5 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-tr-3xl">
        ...
        {/* Navigation Links */}
        <nav className="flex flex-col p-6 space-y-3 font-semibold text-gray-800">
          {navLinks.map((link) => {
