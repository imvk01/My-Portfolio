...
export default function About() {
  return (
    <>
      <div className="min-h-screen w-full bg-gray-50 py-16 px-6 sm:px-10 lg:px-20 lg:mt-[5%] md:mt-[10%] mt-[20%]">
        {/* ===== HEADER SECTION ===== */}
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            I’m{" "}
            <span className="font-semibold text-indigo-600">Vikash Verma</span>,
