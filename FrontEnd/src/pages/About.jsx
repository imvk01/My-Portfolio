...
import { FaCode, FaServer, FaCloud, FaDatabase, FaGraduationCap, FaLanguage } from "react-icons/fa";
    ...
    <div className="min-h-screen w-full bg-gray-50 py-16 px-6 sm:px-10 lg:px-20 lg:mt-[5%]">
      ...
      <div className="max-w-6xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
          I’m <span className="font-semibold text-indigo-600">Vikash Verma</span>, 
          a Full Stack Developer currently pursuing my 
          <span className="font-semibold text-gray-900"> M.Sc. in Software Engineering in Germany</span>. 
          I specialize in building scalable, secure, and production-ready web 
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center mb-20">
        <div className="flex justify-center">
          <img
            ...
            alt="Vikash Verma"
            className="w-64 h-64 object-cover rounded-2xl shadow-xl border-4 border-indigo-100"
          />
        </div>

        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            <span className="text-indigo-600">Full Stack Developer</span> | MERN Specialist
          </h2>
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            payments, and deploying applications using AWS EC2, Nginx, and PM2.
          </p>
      ...
      <div className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 ">
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition hover:-translate-y-2 ">
            <FaCode className="text-indigo-600 text-3xl mb-4" />
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition hover:-translate-y-2">
            <FaServer className="text-indigo-600 text-3xl mb-4" />
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition hover:-translate-y-2">
            <FaCloud className="text-indigo-600 text-3xl mb-4" />
      ...
      <div className="max-w-6xl mx-auto mb-20">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg">
          ...
          <p className="text-gray-500 mb-4">UpGrad Campus – Jalandhar, India</p>

          <ul className="list-disc pl-5 text-gray-600 space-y-2">
            <li>Developed Real Estate Marketplace using MERN stack (TVA Group).</li>
      ...
      <div className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-2xl shadow-md transition hover:-translate-y-2">
            <h3 className="font-semibold text-lg text-indigo-600 mb-2">CareerConnect</h3>
            <p className="text-gray-600 text-sm">
              Full-stack job assistance platform with PayPal subscription billing,
              wallet logic, secure backend APIs, and responsive React frontend.
            </p>
          </div>

          <div className="bg-white p-6 rounded-2xl shadow-md transition hover:-translate-y-2">
            <h3 className="font-semibold text-lg text-indigo-600 mb-2">NeuroRevive 360</h3>
            <p className="text-gray-600 text-sm">
              Physiotherapy clinic website with appointment scheduling and REST APIs.
            </p>
          </div>

          <div className="bg-white p-6 rounded-2xl shadow-md transition hover:-translate-y-2">
            <h3 className="font-semibold text-lg text-indigo-600 mb-2">Som Motor Records</h3>
            <p className="text-gray-600 text-sm">
              Vehicle repair tracking system with invoice generation and data management.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md transition hover:-translate-y-2">
            ...
            <p className="text-gray-600 text-sm">
              Dynamic movie search platform using TMDb API, Redux, and React Router.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* ===== CALL TO ACTION ===== */}
      <div className="max-w-4xl mx-auto text-center bg-indigo-600 text-white py-12 px-8 rounded-3xl shadow-xl">
        <h2 className="text-3xl font-bold mb-4">
          Let’s Build Something Great Together
        </h2>
        <p className="mb-6">
          I’m open to internships, working student roles, and full-time opportunities 
